...
import { VariantesForm } from "@/components/page-garde/VariantesForm";
  ...
  if (!lot) {
    return (
      <div className="space-y-6">
        <p className="text-sm text-muted-foreground">Aucun lot disponible. Retournez à la page Données du projet pour en ajouter.</p>
      </div>
    );
  }
